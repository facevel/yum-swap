...
export default function DonatePage() {
  const {ngoName, donorName, units, product, date} = useStore(donatedItemsStore)
  ...
  const ngoData = [
    ...
    {name: "Give India", address: "Noida, UP", logo: "https://cdn.givind.org/static/images/giveindia-logo-v2.jpg"},
    {
      name: "Cry",
    ...
    <div>
      <div>
        <section className="container items-center justify-center gap-6 pb-8 pt-6 md:py-10">
          <div className={"grid grid-cols-1 md:grid-cols-1 justify-between items-center"}>
            <div className="mb-6 flex max-w-[980px] flex-col items-start gap-2">
              <h1
                ...
                Donation Dashboard<br className="hidden sm:inline"/>
              </h1>
              {donationState === "not-started" &&
                <p className="max-w-[700px] text-lg text-muted-foreground sm:text-xl">
                  Prakhar, here are the NGOs who are accepting donations within your region.
                </p>
              }
              {
                donationState === "selected" &&
                <p className="max-w-[700px] text-lg text-muted-foreground sm:text-xl">
                  Your donation has been finalized ✅! Please proceed to push it to the blockchain.
                </p>
              }
              {
                donationState === "done" &&
                <p className="max-w-[700px] text-lg text-muted-foreground sm:text-xl">
                  You are all done, and your delivery has been scheduled. Thank you for your contribution!
                </p>
              }
            </div>
            {
              ...
              <div>
                <div
                  className={"bg-indigo-800 lg:w-fit justify-self-end border border-indigo-600 my-3 rounded-md text-center p-3 bg-opacity-50 text-indigo-400"}>
                  <p>Donating- <strong>{product} ({units} units)</strong></p>
                </div>
              </div>
            }
          </div>
                  ...
                  return (
                    <div onClick={() => {
                      ...
                      donatedItemsStore.setKey("ngoAddress", ngo.address)
                         ...
                         className="flex dark:hover:bg-gray-800 hover:bg-gray-200 cursor-pointer items-center rounded-xl border bg-white shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:shadow-slate-700/[.7]">
                      <div className={"ml-5 flex h-16 w-16 items-center justify-center rounded-full bg-white"}>
                        <img className="w-28 rounded-b-xl object-cover p-2" src={ngo.logo}
                      ...
                      <div>
                        <div className="p-4 md:p-5">
                          ...
                          <p className="mt-5 text-xs text-gray-500 dark:text-gray-500">
                            In need of: <span className="text-gray-800 dark:text-white">Clothes, Food, Books</span>
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="mb-6 flex max-w-[980px] flex-col items-start gap-2">
                <div className={"flex space-x-4 items-center justify-center"}>
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>NSUT, Dwarka Mor, New Delhi</CardDescription>
                    </CardHeader>

                  </Card>
                  <hr className="h-px w-10 my-8 bg-gray-200 border-0 dark:bg-gray-700"/>
                  <Card>
                    <CardHeader>
                      <CardTitle>Delivery</CardTitle>
                      <CardDescription>{donatedItemsStore.get().ngoName} {donatedItemsStore.get().ngoAddress}</CardDescription>
                    </CardHeader>
                  </Card>
                </div>
                ...
                <button type="button" onClick={() => {
                  setDonationState("done")
                        ...
                        className="mt-5 text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 mr-2">
...

          {
            ...
            <div>
              <div className="mb-6 flex max-w-[980px] flex-col items-start gap-2">
                  ...
                  <div className={"flex items-center justify-center"}>
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>02:00 PM, 25th May, 2023</CardDescription>
                      </CardHeader>
                      <CardContent>
                        Please keep the item ready for pickup at the scheduled time.
                      </CardContent>
                      <CardFooter>
                        Assigned to: &nbsp;<span className="font-bold">Dunzo Pickups</span>
                      </CardFooter>
                    </Card>
                ...
                <Button size={"lg"} className="my-4" onClick={() => {
