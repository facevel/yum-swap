...
const Chat = ({chatData}) => {
  ...
  return (
    <div className={'max-w-3xl w-full h-[calc(90vh-4.7rem)] mx-auto flex flex-col'}>
      <div
        className="flex flex-col items-center text-sm dark:bg-gray-800 overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent"
        ref={messageEl}>
        {
          //@ts-ignore
                  ...
                  <div className="flex-shrink-0 flex flex-col relative items-end w-[30px]">
                    {
                      ...
                      <span
                        className="relative rounded-sm h-[30px] w-[30px] text-white flex items-center justify-center bg-green-400">
          <FaUserNurse/>
          </span>
                    }
                    {
                      message?.role === 'user' &&
                      <span
                        className="relative rounded-sm h-[40px] w-[40px] text-white flex items-center justify-center">
